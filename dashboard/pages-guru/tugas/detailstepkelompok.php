<?php
    ...
    include "../../../koneksi.php";
	  $query = mysqli_query($conn, "SELECT tb_proyekstep.nama_step, tb_proyek.nama_proyek, 
    tb_ketuntasanproyek.tgl_pengumpulan, tb_ketuntasanproyek.file, tb_proyekstep.id_proyekstep, 
    tb_ketuntasanproyek.id_ketuntasanproyek, tb_nilaistep.nilai,
    tb_ketuntasanproyek.status FROM tb_proyek
    ...
    JOIN tb_kelompok ON tb_ketuntasanproyek.id_kelompok=tb_kelompok.id_kelompok
...
<body>
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="notificationDropdown">
              ...
              <a class="dropdown-item preview-item">
                <div class="preview-item-content">
                  <p>
                  <p>Beri nilai berdasarkan hasil pengerjaan tugas</p>
                  <img style="width:90%;" src="../../images/panduan/beri nilai.png">
                  </p>
                </div>
              </a>
            </div>
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-12 grid-margin">
              <div class="row">
                ...
                <h3 class="font-weight-bold"><?php echo $data['nama_step']; ?></h3>
                        <?php
                        if($data['status']=='Selesai'){
                          echo "<div style='font-size:16px;' class='badge badge-success'>Selesai</div>";
                        }else{
          ...
          <div class="row">
            ...
            <div class="col-md-8 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <p class="card-title mb-0">Hasil Pengerjaan Proyek</p><br>
                  <p class="font-weight-500">Proyek <?php echo $data['nama_proyek']; ?> Tahapan <?php echo $data['nama_step']; ?></p>
                  <?php
                  if($data['status']=='Selesai'){
                    
                    echo "<p class='text-muted'>Diunggah pada ".date('d M Y',(strtotime($data["tgl_pengumpulan"])))."</p>";
                    ...
                    echo "<p class='text-muted'>Belum ada dokumen yang diunggah</p>";
                  }
                  ?>
            ...
            <div class="col-md-4 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <p class="card-title mb-0">Beri Nilai</p><br>
                  <?php
                  if($data['status']=='Selesai'){?>
                  
                  <form class="forms-sample" class="pt-3" method="POST" action="ceknilaistep.php?id_ketuntasanproyek=<?php echo $data['id_ketuntasanproyek']; ?>" enctype="multipart/form-data">
                  
                    <div class="form-group">
                      <input type="text" class="form-control" name="nilai" placeholder="Masukkan Nilai" value="<?php echo $data['nilai']; ?>">
                    </div>
                    
                    <button type="submit" name="kirim" class="btn btn-primary mr-2">Submit</button>
                  </form>
                  <?php }else {?>
                    <form class="forms-sample" class="pt-3" method="POST" action="cekbuattugas.php" enctype="multipart/form-data">
                  
                    <div class="form-group">
                      <input type="text" class="form-control" name="nilai" placeholder="Masukkan Nilai" disabled><br>
                      <p style="font-style:italic;"class='text-secondary'>Pemberian nilai dapat dilakukan jika siswa telah mengumpulkan tugas</p>
                    </div>
  ...
  <script>
    ...
    a.href = "../../dokumen/hasil_proyek/<?php echo $data['file']; ?>";
    a.download = "<?php echo $data['file']; ?>";
