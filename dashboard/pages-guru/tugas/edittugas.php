            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="notificationDropdown">
              ...
              <a class="dropdown-item preview-item">
                <div class="preview-item-content">
                  <p>
                  <p>Edit dokumen panduan tugas</p>
                  <img style="width:90%;" src="../../images/panduan/unggah dokumen materi.png">
                  </p>
                </div>
              </a>
              <a class="dropdown-item preview-item">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <h3 class="font-weight-bold">Edit Tugas</h3><br>
          <style>
            html,
            body {
              height: 100%;
          ...
          <div class="row">
            ...
            <?php
            include "../../../koneksi.php";
            $getsiswa = "SELECT * FROM tb_tugas JOIN tb_topik
            ON tb_tugas.id_topik=tb_topik.id_topik
            ...
            ?>
              <div class="card">
                <div class="card-body">
                <form class="forms-sample" class="pt-3" method="POST" action="cekedittugas.php?id_tugas=<?php echo $data['id_tugas']; ?>" enctype="multipart/form-data">
                    <div class="form-group">
                      <label for="exampleInputUsername1">Nama Tugas</label>
                      <input type="text" class="form-control" name="namatugas" value="<?php echo $data['nama_tugas']; ?>" placeholder="Masukkan Nama Tugas">
                    </div>
                    <div class="form-group">
                      <label for="exampleSelectGender">Topik Tugas</label>
                        <select class="form-control" name="topiktugas">
                        <?php
                            if ($data['nama_topik'] == "Konsep Website") {
                            echo "<option value='Konsep Website' selected>Konsep Website</option>";
                            echo "<option value='Pengembangan Frontend'>Pengembangan Frontend</option>";
                            echo "<option value='Pengembangan Backend'>Pengembangan Backend</option>";
                            echo "<option value='Integrasi Website'>Integrasi Website</option>";
                            }
                            else if($data['nama_topik'] == "Pengembangan Frontend") {
                              echo "<option value='Konsep Website'>Konsep Website</option>";
                              echo "<option value='Pengembangan Frontend' selected>Pengembangan Frontend</option>";
                              echo "<option value='Pengembangan Backend'>Pengembangan Backend</option>";
                              echo "<option value='Integrasi Website'>Integrasi Website</option>";
                            }
                              ...
                              echo "<option value='Konsep Website'>Konsep Website</option>";
                              echo "<option value='Pengembangan Frontend'>Pengembangan Frontend</option>";
                              echo "<option value='Pengembangan Backend' selected>Pengembangan Backend</option>";
                              echo "<option value='Integrasi Website'>Integrasi Website</option>";
                            }
                              ...
                              echo "<option value='Pengembangan Frontend'>Pengembangan Frontend</option>";
                              echo "<option value='Pengembangan Backend'>Pengembangan Backend</option>";
                              echo "<option value='Integrasi Website' selected>Integrasi Website</option>";
                            }
                       ?>
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                      <label for="exampleTextarea1">Deskripsi Tugas</label>
                      <textarea class="form-control" name="deskripsitugas" rows="6" placeholder="Masukkan Deskripsi Tugas"><?php echo $data['deskripsi']; ?></textarea>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Deadline Pengumpulan</label>
                      <input type="date" class="form-control" name="deadlinetugas" value="<?php echo $data['deadline']; ?>">
                    </div>
                    <div class="form-group">
