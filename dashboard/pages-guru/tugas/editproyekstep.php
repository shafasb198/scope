<?php
    ...
    $get="SELECT * FROM tb_proyekstep WHERE id_proyekstep='".$_GET["id_proyekstep"]."'";
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="notificationDropdown">
              ...
              <a class="dropdown-item preview-item">
                <div class="preview-item-content">
                  <p>
                  <p>Edit dokumen panduan tahapan proyek</p>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <h3 class="font-weight-bold">Edit Tahapan Proyek</h3><br>
          <style>
            html,
            body {
              height: 100%;
          ...
          <div class="row">
            ...
            <?php
            include "../../../koneksi.php";
            $getsiswa = "SELECT * FROM tb_proyekstep WHERE id_proyekstep='".$_GET["id_proyekstep"]."'";
            ...
            ?>
              <div class="card">
                <div class="card-body">
                <form class="forms-sample" class="pt-3" method="POST" action="cekeditproyekstep.php?id_proyekstep=<?php echo $data['id_proyekstep']; ?>" enctype="multipart/form-data">
                    <div class="form-group">
                      <label for="exampleInputUsername1">Nama Proyek</label>
                      <input type="text" class="form-control" name="namaproyek" value="<?php echo $data['nama_step']; ?>" placeholder="Masukkan Nama Tahapan Proyek">
                    </div>
                    
                    <div class="form-group">
                      <label for="exampleTextarea1">Deskripsi Proyek</label>
                      <textarea class="form-control" name="deskripsiproyek" rows="3" placeholder="Masukkan Deskripsi Tahapan Proyek"><?php echo $data['deskripsi']; ?></textarea>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Tanggal Awal</label>
                      <input type="date" class="form-control" name="tanggalawal" value="<?php echo $data['tgl_mulai']; ?>">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Tanggal Akhir</label>
                      <input type="date" class="form-control" name="tanggalakhir" value="<?php echo $data['tgl_akhir']; ?>">
                    </div>
                    <div class="form-group">
