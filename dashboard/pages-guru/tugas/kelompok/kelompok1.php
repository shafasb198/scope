<?php
    ...
    include "../../../../koneksi.php";
	  $query = mysqli_query($conn, "SELECT * FROM tb_kelompok WHERE id_proyek='".$_GET["id_proyek"]."' LIMIT 1");
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <h3 class="font-weight-bold">Kelompok 1</h3><br>
          <style>
            html,
            body {
              height: 100%;
          ...
          <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
              <form class="forms-sample" class="pt-3" method="POST" action="cek1.php?id_proyek=<?php echo $data["id_proyek"]; ?>" enctype="multipart/form-data">    
