<?php
    ...
    include "../../../koneksi.php";
	  $query = mysqli_query($conn, "SELECT tb_siswa.nama_siswa, tb_siswa.id_siswa, tb_tugas.nama_tugas,
    tb_ketuntasantugas.tanggal, tb_ketuntasantugas.file, tb_nilaitugas.nilai, tb_ketuntasantugas.id_ketuntasantugas, tb_ketuntasantugas.status as statustuntas, tb_akun.foto
    FROM tb_tugas 
    ...
    WHERE tb_tugas.id_tugas='".$_GET["id_tugas"]."' AND tb_ketuntasantugas.id_siswa='".$_GET["id_siswa"]."'");
        ...
        <div class="content-wrapper">
          ...
          <div class="row">
            ...
            <div class="col-md-8 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <p class="card-title mb-0">Hasil Tugas</p><br>
                  <p class="font-weight-500">Tugas <?php echo $data['nama_tugas']; ?></p>
                  <?php
                  if($data['statustuntas']=='Selesai'){
                    
                    echo "<p class='text-muted'>Diunggah pada ".date('d M Y',(strtotime($data["tanggal"])))."</p>";
                    echo "<div class='embed-responsive embed-responsive-16by9'>";
                    echo "<iframe class='embed-responsive-item' src='../../dokumen/hasil_tugas/".$data['file']."' allowfullscreen></iframe>";
                    echo "</div>";
            ...
            <div class="col-md-4 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" class="pt-3" method="POST" action="ceknilai.php?id_ketuntasantugas=<?php echo $data['id_ketuntasantugas']; ?>" enctype="multipart/form-data">
