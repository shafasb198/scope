    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <h3 class="font-weight-bold">Tahapan 3</h3><br>
          <style>
            html,
            body {
              height: 100%;
          ...
          <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
              <form class="forms-sample" class="pt-3" method="POST" action="cekbuatstep3.php" enctype="multipart/form-data">    
                  ...
                  <table style="width: 100%;">
                    <tr>
                      <td style="text-align: right;">                      
                        ...
                        $getjmlstep = "SELECT jumlah_step from tb_proyek WHERE id_proyek='$id_proyek'";
