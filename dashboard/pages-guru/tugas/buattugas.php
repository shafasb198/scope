            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="notificationDropdown">
              ...
              <a class="dropdown-item preview-item">
                <div class="preview-item-content">
                  <p>
                  <p>Klik button Batalkan jika ingin <br>membatalkan pembuatan materi</p>
                  <img style="width:70%;" src="../../images/panduan/batalkan.png">
                  </p>
                </div>
              </a>
              <a class="dropdown-item preview-item">
                <div class="preview-item-content">
                  <p>
                  <p>Unggah dokumen panduan tugas</p>
              ...
              <a class="dropdown-item preview-item">
                <div class="preview-item-content">
                  <p>
                  <p>Klik button Buat Tugas jika semua <br>sudah terisi</p>
                  <img style="width:70%;" src="../../images/panduan/button buat tugas.png">
                  </p>
                </div>
              </a>
        ...
        <table style="width:100%;">
          <tr>
            <td style="vertical-align: middle;">
              <h3 class="font-weight-bold">Buat Tugas Baru</h3><br>
            </td>
          ...
          <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
              ...
              <form class="forms-sample" class="pt-3" method="POST" action="cekbuattugas.php" enctype="multipart/form-data">
                <?php
                      include "../../../koneksi.php";
                      $get = "SELECT id_topik, nama_topik FROM tb_topik";
                      $eks = mysqli_query($conn, $get);
                      $hasil = mysqli_num_rows($eks);?>
                  <div class="form-group">
                    <label for="exampleInputUsername1">Nama Tugas</label>
                    <input type="text" class="form-control" name="namatugas" placeholder="Masukkan Nama Tugas">
                  </div>
                  <div class="form-group">
                    <label for="exampleSelectGender">Topik Tugas</label>
                      ...
                      if($hasil>0){
                        while($data = mysqli_fetch_array($eks)){
                          echo "<option>".$data['id_topik']." - ".$data['nama_topik']."</option>";
                        }}
                      ?>
                      </select>
                    </div>
                  <div class="form-group">
                    ...
                    <textarea class="form-control" name="deskripsitugas" rows="6" placeholder="Masukkan Deskripsi Tugas"></textarea>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Deadline Pengumpulan</label>
                    <input type="date" class="form-control" name="deadlinetugas">
                  </div>
                  <div class="form-group">
                  ...
                  <button type="submit" name="btn_buattugas" class="btn btn-primary mr-2">Buat Tugas</button>
                </form>
              </div>
            </div>
          </div>
