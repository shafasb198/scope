<?php
    ...
    $get="SELECT * FROM tb_komentartugas WHERE id_komentartugas='".$_GET["id_komentartugas"]."'";
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="row">
            ...
            JOIN tb_siswa ON tb_komentartugas.id_siswa=tb_siswa.id_siswa
            LEFT JOIN tb_balasantugas ON tb_balasantugas.id_komentartugas=tb_komentartugas.id_komentartugas
            WHERE tb_komentartugas.id_komentartugas='".$_GET["id_komentartugas"]."'";
            ...
            ?>
              <div class="card">
                <div class="card-body">
                  <form class="forms-sample" class="pt-3" method="POST" action="cekbalastugas.php?id_komentartugas=<?php echo $_GET['id_komentartugas']; ?>" enctype="multipart/form-data">
                    <div class="form-group">
                      <label for="exampleInputUsername1">Nama Siswa</label>
                      <input type="text" class="form-control" name="namaproyek" value="<?php echo $data['nama_siswa']; ?>" readonly placeholder="Masukkan Nama Tugas">
                    </div>                    
                    <div class="form-group">
                      <label for="exampleTextarea1">Isi Komentar</label>
                      <textarea class="form-control" name="deskripsiproyek" rows="3" placeholder="Masukkan Deskripsi Tugas" readonly><?php echo $data['isi_komentartugas']; ?></textarea>
                    </div>                   
                    <div class="form-group">
                      <label for="exampleTextarea1">Balas Komentar</label>
                      <textarea class="form-control" name="balaskomentar" rows="3" placeholder="Masukkan Balasan Anda"><?php echo $data['isi_balasantugas']; ?></textarea>
                    </div>
