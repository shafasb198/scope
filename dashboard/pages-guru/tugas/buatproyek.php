            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="notificationDropdown">
              ...
              <a class="dropdown-item preview-item">
                <div class="preview-item-content">
                  <p>
                  <p>Klik Lanjutkan untuk menyelesaikan pembuatan proyek</p>
        ...
        <table style="width:100%;">
          <tr>
            <td style="vertical-align: middle;">
              <h3 class="font-weight-bold">Buat Proyek Baru</h3><br>
            </td>
          ...
          <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                <form class="forms-sample" class="pt-3" method="POST" action="cekbuatproyek.php" enctype="multipart/form-data">
                  <div class="form-group">
                    <label for="exampleInputUsername1">Nama Proyek</label>
                    <input type="text" class="form-control" name="namaproyek" placeholder="Masukkan Nama Proyek">
                  </div>                  
                  <div class="form-group">
                    <label for="exampleTextarea1">Deskripsi Proyek</label>
                    <textarea class="form-control" name="deskripsiproyek" rows="6" placeholder="Masukkan Deskripsi Tugas"></textarea>
                  </div>
                  <div class="form-group">
                    <label for="exampleSelectGender">Jumlah Tahapan Proyek</label>
                      <select class="form-control" name="jumlahstep">
                        <option>1</option>
                        <option>2</option>
                        <option>3</option>
                        <option>4</option>
                  ...
                  <div class="form-group">
                    <label for="exampleSelectGender">Jumlah Kelompok Proyek</label>
                      <select class="form-control" name="jumlahkelompok">
                        <option>1</option>
                        <option>2</option>
                        <option>3</option>
                        <option>4</option>
