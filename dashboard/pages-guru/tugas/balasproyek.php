<?php
    ...
    $get="SELECT * FROM tb_komentarproyek WHERE id_komentarproyek='".$_GET["id_komentarproyek"]."'";
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="notificationDropdown">
              ...
              <a class="dropdown-item preview-item">
                <div class="preview-item-content">
                  <p>
                  <p>Masukkan Balasan Komentar dan klik button Balas Komentar</p>
                  <img style="width:50%;" src="../../images/panduan/balas komentar.png">
                  </p>
                </div>
              </a>
            </div>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <h3 class="font-weight-bold">Balas Komentar Tugas</h3><br>
          <style>
            html,
            body {
              height: 100%;
          ...
          <div class="row">
            ...
            $getsiswa = "SELECT * FROM tb_komentarproyek
            JOIN tb_siswa ON tb_komentarproyek.id_siswa=tb_siswa.id_siswa
            JOIN tb_proyekstep ON tb_komentarproyek.id_proyekstep=tb_proyekstep.id_proyekstep
            JOIN tb_proyek ON tb_proyekstep.id_proyek=tb_proyek.id_proyek
            LEFT JOIN tb_balasanproyek ON tb_balasanproyek.id_komentarproyek=tb_komentarproyek.id_komentarproyek
            WHERE tb_komentarproyek.id_komentarproyek='".$_GET["id_komentarproyek"]."'";
            ...
            ?>
              <div class="card">
                <div class="card-body">
                <form class="forms-sample" class="pt-3" method="POST" action="cekbalasproyek.php?id_komentarproyek=<?php echo $_GET['id_komentarproyek']; ?>" enctype="multipart/form-data">
                    <div class="form-group">
                      <label for="exampleInputUsername1">Nama Siswa</label>
                      <input type="text" class="form-control" name="namaproyek" value="<?php echo $data['nama_siswa']; ?>" readonly placeholder="Masukkan Nama Proyek">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputUsername1">Tahapan Proyek</label>
                      <input type="text" class="form-control" name="namaproyek" value="<?php echo $data['nama_step']; ?>" readonly placeholder="Masukkan Nama Proyek">
                    </div>                    
                    <div class="form-group">
                      <label for="exampleTextarea1">Isi Komentar</label>
                      <textarea class="form-control" name="deskripsiproyek" rows="3" placeholder="Masukkan Deskripsi Tugas" readonly><?php echo $data['isi_komentarproyek']; ?></textarea>
                    </div>                   
                    <div class="form-group">
                      <label for="exampleTextarea1">Balas Komentar</label>
                      <textarea class="form-control" name="balaskomentar" rows="3" placeholder="Masukkan Balasan Anda"><?php echo $data['isi_balasanproyek']; ?></textarea>
                    </div>

                    <button type="submit" name="kirim" class="btn btn-primary mr-2">Balas Komentar</button>
                  </form>
                </div>
              </div><?php }}?>
            </div>
