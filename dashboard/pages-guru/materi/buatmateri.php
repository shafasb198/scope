        ...
        <li class="nav-item dropdown show">
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="notificationDropdown">
              ...
              <a class="dropdown-item preview-item">
                <div class="preview-item-content">
                  <p>
                  <p>Klik button Buat Materi jika semua <br>sudah terisi</p>
                  <img style="width:70%;" src="../../images/panduan/button buat materi.png">
                  </p>
                </div>
              </a>
        ...
        <table style="width:100%;">
          <tr>
            <td style="vertical-align: middle;">
              <h3 class="font-weight-bold">Buat Materi Baru</h3><br>
            </td>
          ...
          <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                <form class="forms-sample" class="pt-3" method="POST" action="cekbuatmateri.php" enctype="multipart/form-data">
                <?php
                      include "../../../koneksi.php";
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="namamateri" placeholder="Masukkan Nama Materi">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="linkvideo" name="linkvideo" placeholder="Masukkan Link Video Materi">
                  </div>
                  <div class="form-group">
                    <label for="exampleTextarea1">Deskripsi Materi</label>
                    <textarea class="form-control" name="isimateri" rows="6" placeholder="Masukkan Isi Materi"></textarea>
                  </div>
                  <div class="form-group">
                  ...
                  <button type="submit" name="btn_buatmateri" class="btn btn-primary mr-2">Buat Materi</button>
                </form>
              </div>
            </div>
          </div>
