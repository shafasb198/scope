<?php
    ...
    include "../../../../koneksi.php";
    $query = mysqli_query($conn, "SELECT * FROM tb_kuis WHERE id_kuis='".$_GET["id_kuis"]."'");
  ...
  <div class="container-scroller">
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="notificationDropdown">
              ...
              <a class="dropdown-item preview-item">
                <div class="preview-item-content">
                  <p>
                  <p>Masukkan Soal yang dibuat</p>
                  <img src="../../../images/panduan/soal.png">
                  </p>
                </div>
              </a>
              <a class="dropdown-item preview-item">
                <div class="preview-item-content">
                  <p>
                  <p>Masukkan Opsi Jawaban yang Benar</p>
                  <img src="../../../images/panduan/jaw benar.png">
                  </p>
                </div>
              </a>
              <a class="dropdown-item preview-item">
                <div class="preview-item-content">
                  <p>
                  <p>Masukkan Opsi Jawaban yang Salah</p>
                  <img src="../../../images/panduan/jaw salah.png">
                  </p>
                </div>
              </a>
              <a class="dropdown-item preview-item">
                <div class="preview-item-content">
                  ...
                  <img src="../../../images/panduan/button buat kuis akhir.png">
                  </p>
                </div>
              </a>
            </div>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        ...
        <h3 class="font-weight-bold">Buat Soal</h3><br><br>
          <style>
            html,
            body {
              height: 100%;
          ...
          <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
            <div class="card-body">
            <form class="forms-sample" class="pt-3" method="POST" action="cekbuatsoal.php?id_kuis=<?php echo $data['id_kuis'];?>" enctype="multipart/form-data">
                    ...
                    <div class="row">
                      ...
                      <p class="card-description">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" name="soal1" class="form-control">
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        ...
                        <div class="form-group row">                          
                          <div class="col-sm-11">
                            <input type="text" name="benar1" class="form-control">
                          </div>
                    ...
                    <div class="row">                      
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">                          
                          <div class="col-sm-11">
                            <input type="text" name="salah1a" class="form-control">
                          </div>
                          <label class="badge badge-danger"><i class='ti-close'></i></i></label>
                        </div>
                      </div>
                    </div>
                    <div class="row">                      
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">                          
                          <div class="col-sm-11">
                            <input type="text" name="salah1b" class="form-control">
                          </div>
                          <label class="badge badge-danger"><i class='ti-close'></i></i></label>
                        </div>
                      </div>
                    ...
                    <div class="row">                      
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">                          
                          <div class="col-sm-11">
                            <input type="text" name="salah1c" class="form-control">
                          </div>
                          <label class="badge badge-danger"><i class='ti-close'></i></i></label>
                        </div>
                      </div>
                    ...
                    <div class="row">                      
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">                          
                          <div class="col-sm-11">
                            <input type="text" name="salah1d" class="form-control">
                          </div>
                          <label class="badge badge-danger"><i class='ti-close'></i></i></label>
                        </div>
                      </div>
                    ...
                    <div class="row">
                      ...
                      <p class="card-description">
                        ...
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label">Soal</label>
                          <div class="col-sm-9">
                            <input type="text" name="soal2" class="form-control">
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        ...
                        <div class="form-group row">                          
                          <div class="col-sm-11">
                            <input type="text" name="benar2" class="form-control">
                          </div>
                          <label class="badge badge-success"><i class='ti-check'></i></label>
                        </div>
                      </div>
                    ...
                    <div class="row">                      
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">                          
                          <div class="col-sm-11">
                            <input type="text" name="salah2a" class="form-control">
                          </div>
                          <label class="badge badge-danger"><i class='ti-close'></i></i></label>
                        </div>
                      </div>
                    ...
                    <div class="row">                      
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">                          
                          <div class="col-sm-11">
                            <input type="text" name="salah2b" class="form-control">
                          </div>
                          <label class="badge badge-danger"><i class='ti-close'></i></i></label>
                        </div>
                      </div>
                    ...
                    <div class="row">                      
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">                          
                          <div class="col-sm-11">
                            <input type="text" name="salah2c" class="form-control">
                          </div>
                          <label class="badge badge-danger"><i class='ti-close'></i></i></label>
                        </div>
                      </div>
                    ...
                    <div class="row">                      
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">                          
                          <div class="col-sm-11">
                            <input type="text" name="salah2d" class="form-control">
                          </div>
                          <label class="badge badge-danger"><i class='ti-close'></i></i></label>
                        </div>
                      </div>
                    ...
                    <div class="row">
                      ...
                      <p class="card-description">
                        ...
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label">Soal</label>
                          <div class="col-sm-9">
                            <input type="text" name="soal3" class="form-control">
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        ...
                        <div class="form-group row">                          
                          <div class="col-sm-11">
                            <input type="text" name="benar3" class="form-control">
                          </div>
                          <label class="badge badge-success"><i class='ti-check'></i></label>
                        </div>
                      </div>
                    ...
                    <div class="row">                      
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">                          
                          <div class="col-sm-11">
                            <input type="text" name="salah3a" class="form-control">
                          </div>
                          <label class="badge badge-danger"><i class='ti-close'></i></i></label>
                        </div>
                      </div>
                    ...
                    <div class="row">                      
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">                          
                          <div class="col-sm-11">
                            <input type="text" name="salah3b" class="form-control">
                          </div>
                          <label class="badge badge-danger"><i class='ti-close'></i></i></label>
                        </div>
                      </div>
                    ...
                    <div class="row">                      
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">                          
                          <div class="col-sm-11">
                            <input type="text" name="salah3c" class="form-control">
                          </div>
                          <label class="badge badge-danger"><i class='ti-close'></i></i></label>
                        </div>
                      </div>
                    ...
                    <div class="row">                      
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">                          
                          <div class="col-sm-11">
                            <input type="text" name="salah3d" class="form-control">
                          </div>
                          <label class="badge badge-danger"><i class='ti-close'></i></i></label>
                        </div>
                      </div>
                    ...
                    <div class="row">
                      ...
                      <p class="card-description">
                        ...
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label">Soal</label>
                          <div class="col-sm-9">
                            <input type="text" name="soal4" class="form-control">
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        ...
                        <div class="form-group row">                          
                          <div class="col-sm-11">
                            <input type="text" name="benar4" class="form-control">
                          </div>
                          <label class="badge badge-success"><i class='ti-check'></i></label>
                        </div>
                      </div>
                    ...
                    <div class="row">                      
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">                          
                          <div class="col-sm-11">
                            <input type="text" name="salah4a" class="form-control">
                          </div>
                          <label class="badge badge-danger"><i class='ti-close'></i></i></label>
                        </div>
                      </div>
                    ...
                    <div class="row">                      
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">                          
                          <div class="col-sm-11">
                            <input type="text" name="salah4b" class="form-control">
                          </div>
                          <label class="badge badge-danger"><i class='ti-close'></i></i></label>
                        </div>
                      </div>
                    ...
                    <div class="row">                      
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">                          
                          <div class="col-sm-11">
                            <input type="text" name="salah4c" class="form-control">
                          </div>
                          <label class="badge badge-danger"><i class='ti-close'></i></i></label>
                        </div>
                      </div>
                    ...
                    <div class="row">                      
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">                          
                          <div class="col-sm-11">
                            <input type="text" name="salah4d" class="form-control">
                          </div>
                          <label class="badge badge-danger"><i class='ti-close'></i></i></label>
                        </div>
                      </div>
                    ...
                    <div class="row">
                      ...
                      <p class="card-description">
                        ...
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label">Soal</label>
                          <div class="col-sm-9">
                            <input type="text" name="soal5" class="form-control">
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        ...
                        <div class="form-group row">                          
                          <div class="col-sm-11">
                            <input type="text" name="benar5" class="form-control">
                          </div>
                          <label class="badge badge-success"><i class='ti-check'></i></label>
                        </div>
                      </div>
                    ...
                    <div class="row">                      
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">                          
                          <div class="col-sm-11">
                            <input type="text" name="salah5a" class="form-control">
                          </div>
                          <label class="badge badge-danger"><i class='ti-close'></i></i></label>
                        </div>
                      </div>
                    ...
                    <div class="row">                      
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">                          
                          <div class="col-sm-11">
                            <input type="text" name="salah5b" class="form-control">
                          </div>
                          <label class="badge badge-danger"><i class='ti-close'></i></i></label>
                        </div>
                      </div>
                    ...
                    <div class="row">                      
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">                          
                          <div class="col-sm-11">
                            <input type="text" name="salah5c" class="form-control">
                          </div>
                          <label class="badge badge-danger"><i class='ti-close'></i></i></label>
                        </div>
                      </div>
                    ...
                    <div class="row">                      
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">                          
                          <div class="col-sm-11">
                            <input type="text" name="salah5d" class="form-control">
                          </div>
                          <label class="badge badge-danger"><i class='ti-close'></i></i></label>
                        </div>
                      </div>
                    ...
                    <button type="submit" name="btn_buatsoal" class="btn btn-primary mr-2">Buat Kuis</button>
