<?php
    ...
    include "../../../koneksi.php";
    $query = mysqli_query($conn, "SELECT * FROM tb_tugas WHERE id_tugas='".$_GET["id_tugas"]."'");
        ...
        <li class="nav-item dropdown show">
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="notificationDropdown">
              ...
              <a class="dropdown-item preview-item">
                <div class="preview-item-content">
                  <table style="width:100%;">
                    <tr>
                      <td>
                      <p>Baca panduan tugas <br>pada file yang tersedia</p>
                      </td>
                      <td style="text-align:right;"><img style="width:70%;" src="../../images/panduan/pdf tugas.png"></td>
                    </tr>
                  </table>                
              ...
              <a class="dropdown-item preview-item">
                <div class="preview-item-content">
                  <br>
                  <p>Unggah hasil pengerjaan tugas dalam format .pdf</p>
                  <img style="width:50%;" src="../../images/panduan/unggah proyek.png">
                  </p>
                </div>
              </a>      
              <a class="dropdown-item preview-item">
                <div class="preview-item-content">
                  <table style="width:100%;">
                    <tr>
                      <td>
                      <p>Kirim komentar atau <br>pertanyaan</p>
                      </td>
              ...
              <a class="dropdown-item preview-item">
                <div class="preview-item-content">
                  <table style="width:100%;">
                    <tr>
                      <td>
                      <p>Lihat riwayat komentar <br>yang terkirim atau<br>sudah dibalas</p>
                      </td>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <h3 class="font-weight-bold"><?php echo $data['nama_tugas'];?></h3><br>
          <style>
            html,
            body {
              height: 100%;
          ...
          <div class="row" id="html">
                  <div class="col-md-8 grid-margin stretch-card">
                      <div class="card position-relative">
                        <div class="card-body">
                          <p class="card-title mb-0">Panduan Tugas</p><br>
                          <div class="embed-responsive embed-responsive-16by9">
                                <iframe class="embed-responsive-item" src="../../dokumen/panduan_tugas/<?php echo $data['file']; ?>" allowfullscreen></iframe>
                          </div> 
                        </div>
                      </div>
                  </div>
                  ...
                  <div class="col-md-4 grid-margin">
                    <div class="card">
                      <div class="card-body">
                        <p class="card-title mb-0">Detail Tugas</p>
                        <?php
                        $getdetail = mysqli_query($conn, "SELECT * FROM tb_tugas
                        JOIN tb_topik ON tb_topik.id_topik=tb_tugas.id_topik
                        ...
                        WHERE tb_tugas.id_tugas='".$_GET["id_tugas"]."' AND tb_siswa.id_siswa='".$id_siswa."'");
                        if ($detail = mysqli_fetch_array($getdetail)){
                        ?>
                          <p>Topik: <?php echo $detail['nama_topik']; ?></p><br>
                          <p><?php echo $detail['deskripsi']; ?></p><br>
                            <p class="font-weight-bold">Tenggat Pengumpulan</p>
                            <mark class="bg-primary text-white"><?php echo $detail['deadline']; ?></mark><br><br>
                      </div>
          ...
          <div class="row" id="html">
                    <div class="col-md-8 grid-margin stretch-card">
                      ...
                      "SELECT tb_ketuntasantugas.id_ketuntasantugas, tb_ketuntasantugas.status as tuntas, tb_ketuntasantugas.file FROM tb_siswa
                      JOIN tb_ketuntasantugas ON tb_siswa.id_siswa=tb_ketuntasantugas.id_siswa
                      JOIN tb_tugas ON tb_tugas.id_tugas=tb_ketuntasantugas.id_tugas
                      WHERE tb_siswa.id_siswa='".$id_siswa."' AND tb_tugas.id_tugas='".$_GET['id_tugas']."'");
                      if ($data = mysqli_fetch_array($gettuntas)){
                      ?>
                      <div class="card">
                        <div class="card-body">
                          <p class="card-title mb-0">Unggah Hasil Pengerjaan</p><br>
                          <form class="forms-sample" class="pt-3" method="POST" action="cekuptugas.php?id_ketuntasantugas=<?php echo $data['id_ketuntasantugas']; ?> & id_tugas=<?php echo $_GET['id_tugas']; ?>" enctype="multipart/form-data">
                          <?php
                          
                          
                            if($data['tuntas']=='Selesai'){
                              if(substr($data['file'],-3)=='pdf'){
                                echo "<p>Hasil Tugas Anda</p>";
                                echo "<iframe style='height:350px; width: 100%;' class='embed-responsive-item' src='../../dokumen/hasil_tugas/".$data['file']."' allowfullscreen></iframe>";
                              }
                              else if(substr($data['file'],-3)=='zip' || substr($data['file'],-3)=='rar'){
                                echo "<p>Hasil Tugas Anda</p>";
                                echo "<a href='../../dokumen/hasil_tugas/".$data["file"]."' download ><button type='button' class='btn btn-outline-success btn-icon-text'>
                              <i class='ti-download btn-icon-prepend'></i>                                                    
                              ".$data['file']."</button></a>";
                              }

                              $getnilai = mysqli_query($conn, 
                              "SELECT tb_nilaitugas.nilai FROM tb_nilaitugas JOIN tb_ketuntasantugas
                              ON tb_ketuntasantugas.id_ketuntasantugas=tb_nilaitugas.id_ketuntasantugas
                              JOIN tb_siswa ON tb_ketuntasantugas.id_siswa=tb_siswa.id_siswa
                      ...
                      <div class="card">
                        <div class="card-body">
                          <p class="card-title mb-0">Komentar</p><br>
                            <form class="forms-sample" class="pt-3" method="POST" action="cekkomen.php?id_tugas=<?php echo $detail['id_tugas']; ?>" enctype="multipart/form-data">                
                          ...
                          <p class="card-title mb-0">Riwayat Komentar</p><br>
                            ...
                            <?php
                            $get = "SELECT tb_komentartugas.tanggal as tgl_komen, tb_balasantugas.tanggal as tgl_balas,
                            tb_siswa.nama_siswa, tb_akun.foto, tb_komentartugas.isi_komentartugas
                            FROM tb_tugas JOIN tb_komentartugas ON tb_tugas.id_tugas=tb_komentartugas.id_tugas
                            JOIN tb_siswa ON tb_komentartugas.id_siswa=tb_siswa.id_siswa
                            LEFT JOIN tb_balasantugas ON tb_balasantugas.id_komentartugas=tb_komentartugas.id_komentartugas
                            JOIN tb_akun ON tb_akun.id_akun=tb_siswa.id_akun
                            WHERE tb_tugas.id_tugas='".$_GET["id_tugas"]."' AND tb_siswa.id_siswa='".$id_siswa."' AND tb_balasantugas.id_balasantugas IS NULL";
                            ...
                            $hasil = mysqli_num_rows($eks);
                              ...
                              if($hasil>0){
                                while($data = mysqli_fetch_array($eks)){
                                  ...
                                  echo "<p class='mb-0'>".$data['isi_komentartugas']."</p>";
                          ...
                          <ul class="icon-data-list">
                            <?php
                            $get = "SELECT * FROM tb_tugas
                            JOIN tb_komentartugas ON tb_tugas.id_tugas=tb_komentartugas.id_tugas
                            JOIN tb_balasantugas ON tb_komentartugas.id_komentartugas=tb_balasantugas.id_komentartugas
                            JOIN tb_siswa ON tb_siswa.id_siswa=tb_komentartugas.id_siswa
                            JOIN tb_guru ON tb_guru.id_guru=tb_balasantugas.id_guru
                            JOIN tb_akun ON tb_akun.id_akun=tb_guru.id_akun
                            WHERE tb_tugas.id_tugas='".$_GET['id_tugas']."' AND tb_siswa.id_siswa='".$id_siswa."'";
                            $eks = mysqli_query($conn, $get);
                            $hasil = mysqli_num_rows($eks);
                              ...
                              if($hasil>0){
                                while($data = mysqli_fetch_array($eks)){
                                  ...
                                  echo "<p class='mb-0'>".$data['isi_komentartugas']."</p>";
                                  echo "<p class='font-weight-bold'>Balasan: ".$data['isi_balasantugas']."</p>";
                                  }}
