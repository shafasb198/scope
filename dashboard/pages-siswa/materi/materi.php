            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="notificationDropdown">
              ...
              <a class="dropdown-item preview-item">
                <div class="preview-item-content">
                  <p>
                  <p>Klik Button Detail Materi untuk melihat materi</p>
              ...
              <a class="dropdown-item preview-item">
                <div class="preview-item-content">
                  <p>
                  <p>Lihat ketuntasan materi yang telah dikerjakan</p>
                  <img src="../../images/panduan/ketuntasan materi.png">
                  </p>
                </div>
              </a>
            </div>
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="row">
                ...
                <div class="card-body">
                  <div class="table-responsive">
                    <table class="table table-striped table-borderless">
                      ...
                      $getstatus="SELECT * FROM tb_materi
                      JOIN tb_ketuntasanmateri ON tb_materi.id_materi=tb_ketuntasanmateri.id_materi
                      JOIN tb_siswa ON tb_ketuntasanmateri.id_siswa=tb_siswa.id_siswa
                      ...
                      ?>
                        <tr>
                          <td><?php echo $datanya['nama_materi']?></td>
                          <td><?php 
                          ...
                          ?></td>
                          <td><a href ="detailmateri.php?id_materi=<?php echo $datanya['id_materi']; ?>" name="detail"><button type='button' class='btn btn-primary btn-sm'>Detail Materi</button></a>&nbsp;</td>
                        </tr>
                      <?php }} else{
                        echo "<tr>
                        <td colspan=3><p>Belum ada materi baru<p></td>
                      </tr>";
                      }?>
                      </tbody>
                    </table>
            ...
            <?php
            $getjumlahmateri="SELECT COUNT(id_materi) as jml_materi FROM tb_materi";
            $jumlahmateri = mysqli_query($conn, $getjumlahmateri);
            $hasiljumlah = mysqli_num_rows($jumlahmateri);
            if($hasiljumlah>0){
              while($dataa = mysqli_fetch_array($jumlahmateri)){

            $getstatus="SELECT COUNT(tb_materi.id_materi) as ketuntasan FROM tb_materi
            JOIN tb_ketuntasanmateri ON tb_materi.id_materi=tb_ketuntasanmateri.id_materi
            JOIN tb_siswa ON tb_ketuntasanmateri.id_siswa=tb_siswa.id_siswa
            WHERE tb_ketuntasanmateri.status='Selesai' AND tb_siswa.id_siswa='".$id_siswa."'";
            $statusnya = mysqli_query($conn, $getstatus);
            $hasilnya = mysqli_num_rows($statusnya);
            if($hasilnya>0){
              while($datanya = mysqli_fetch_array($statusnya)){
            ...
            <div class="col-md-4 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <p class="card-title mb-0">Ketuntasan</p><br>
                  <?php
                  if($dataa['jml_materi']!=0){
                    $persen=($datanya['ketuntasan']/$dataa['jml_materi'])*100;
                  }else{
                    $persen=0;
                  }
                  ?>
                  <div class="progress">
                    ...
                    <p class="card-description"><?php echo $datanya['ketuntasan']; ?> dari <?php echo $dataa['jml_materi']; ?> materi telah dituntaskan</p>
                    <br>
                </div>
              </div>
            </div> 
