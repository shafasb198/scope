            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="notificationDropdown">
              ...
              <a class="dropdown-item preview-item">
                <div class="preview-item-content">
                  <p>
                  <p>Pada halaman ini, kerjakan kuis yang berisi<br>5 soal. Jika hasil kuis dibawah 80,<br>kerjakan kembali kuis</p>
                  </p>
                </div>
              </a>
            </div>
        ...
        <table style="width:100%;">
          <tr>
            <td style="vertical-align: middle;">
              <h3 class="font-weight-bold">Kuis <?php echo $data['nama_materi'];?></h3><br>
            </td>
          </tr>
        </table><br>
          <style>
          ...
          <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
            <div class="card-body">
            <form class="forms-sample" class="pt-3" method="POST" action="cekkuis.php?id_kuis=<?php echo $data['id_kuis'];?>" enctype="multipart/form-data">
            ...
            echo "<h5>".$soal['isi_soal']."</h5>";
            
                  $getopsi = "SELECT tb_opsi.opsi ,tb_opsi.status FROM tb_opsi JOIN tb_soal ON tb_soal.id_soal=tb_opsi.id_soal
                  ...
                  if($hasilopsi>0){
                    while($opsi = mysqli_fetch_array($eksopsi)){
                      echo "<div class='col-md-12'><div class='form-group'><div class='form-check'>
                          <label class='form-check-label'>
                            <input type='radio' name='opsi1' class='form-check-input' id='OpsiSoal1' value='".$opsi['opsi']."'>
                            ".$opsi['opsi']."
                          <i class='input-helper'></i></label></div></div></div>";
                    }
                  }
                  echo "<br>";   
            ?><br><br>
...
<?php
            ...
            echo "<h5>".$soal['isi_soal']."</h5>";
                  ...
                  if($hasilopsi>0){
                    while($opsi = mysqli_fetch_array($eksopsi)){
                      echo "<div class='col-md-12'><div class='form-group'><div class='form-check'>
                          <label class='form-check-label'>
                            <input type='radio' name='opsi2' class='form-check-input' id='OpsiSoal3' value='".$opsi['opsi']."'>
                            ".$opsi['opsi']."
                          <i class='input-helper'></i></label></div></div></div>";
                    }
                  }
            ...
            echo "<h5>".$soal['isi_soal']."</h5>";
                  ...
                  if($hasilopsi>0){
                    while($opsi = mysqli_fetch_array($eksopsi)){
                      echo "<div class='col-md-12'><div class='form-group'><div class='form-check'>
                          <label class='form-check-label'>
                            <input type='radio' name='opsi3' class='form-check-input' id='OpsiSoal3' value='".$opsi['opsi']."'>
                            ".$opsi['opsi']."
                          <i class='input-helper'></i></label></div></div></div>";
                    }
                  }
            ...
            echo "<h5>".$soal['isi_soal']."</h5>";
                  ...
                  if($hasilopsi>0){
                    while($opsi = mysqli_fetch_array($eksopsi)){
                      echo "<div class='col-md-12'><div class='form-group'><div class='form-check'>
                          <label class='form-check-label'>
                            <input type='radio' name='opsi4' class='form-check-input' id='OpsiSoal4' value='".$opsi['opsi']."'>
                            ".$opsi['opsi']."
                          <i class='input-helper'></i></label></div></div></div>";
                    }
                  }
            ...
            echo "<h5>".$soal['isi_soal']."</h5>";
                  ...
                  if($hasilopsi>0){
                    while($opsi = mysqli_fetch_array($eksopsi)){
                      echo "<div class='col-md-12'><div class='form-group'><div class='form-check'>
                          <label class='form-check-label'>
                            <input type='radio' name='opsi5' class='form-check-input' id='OpsiSoal5' value='".$opsi['opsi']."'>
                            ".$opsi['opsi']."
                          <i class='input-helper'></i></label></div></div></div>";
                    }
                  }
            ...
            ?><br><br>
                    ...
                    <button type="button" name="btn_batalkan" class="btn btn-outline-primary mr-2">Kembali</button>
                    <button type="submit" name="btn_selesai" class="btn btn-primary mr-2">Selesai</button>
