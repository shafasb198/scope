<?php
    ...
    include "../../../../koneksi.php";
    $query = mysqli_query($conn, "SELECT * FROM tb_kuis JOIN tb_materi
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="notificationDropdown">
              ...
              <a class="dropdown-item preview-item">
                <div class="preview-item-content">
                  <p>
                  <p>Pada halaman ini, lihat hasil pengerjaan<br>kuis dan pelajari jawaban yang salah</p>
                  </p>
                </div>
              </a>
            </div>
        ...
        <table style="width:100%;">
          <tr>
            <td style="vertical-align: middle;">
              <h3 class="font-weight-bold">Hasil Kuis <?php echo $data['nama_materi'];?></h3><br>
            </td>
          </tr>
        </table><br>
          <style>
          ...
          <div class="col-md-12 grid-margin stretch-card">
            ...
            $getsoal = "SELECT * FROM tb_soal JOIN tb_kuis ON tb_soal.id_kuis=tb_kuis.id_kuis
            JOIN tb_materi ON tb_materi.id_materi=tb_kuis.id_materi WHERE tb_materi.id_materi='".$_GET["id_materi"]."' AND tb_soal.nomor='1'";
            $eksekusi = mysqli_query($conn, $getsoal);
            $soal = mysqli_fetch_array($eksekusi);   
            
            echo "<h4>Soal ".$soal['nomor']."</h4>";
            echo "<h5>Soal ".$soal['isi_soal']."</h5>";
            
            $getjaw = "SELECT * FROM tb_jawaban JOIN tb_soal ON tb_soal.id_soal=tb_jawaban.id_soal
            JOIN tb_siswa ON tb_siswa.id_siswa=tb_jawaban.id_siswa WHERE tb_soal.id_soal='".$soal["id_soal"]."'
            AND tb_siswa.id_siswa='".$id_siswa."'";
            $eksjaw = mysqli_query($conn, $getjaw);
            $hasiljaw = mysqli_num_rows($eksjaw);
                      
            if($hasiljaw>0){
              while($jaw = mysqli_fetch_array($eksjaw)){
                $jawaban=$jaw['id_opsi'];
                
                  $getopsi = "SELECT tb_opsi.id_opsi, tb_opsi.opsi ,tb_opsi.status FROM tb_opsi JOIN tb_soal ON tb_soal.id_soal=tb_opsi.id_soal
                  WHERE tb_soal.id_soal='".$soal["id_soal"]."' ORDER BY RAND()";
                  $eksopsi = mysqli_query($conn, $getopsi);
                  $hasilopsi = mysqli_num_rows($eksopsi);
                  
                  if($hasilopsi>0){
                    while($opsi = mysqli_fetch_array($eksopsi)){
                      if($opsi['status']=='Benar'){
                        $benar=$opsi['id_opsi'];
                        $opsibenar=$opsi['opsi'];
                        if($opsi['id_opsi']==$jaw['id_opsi']){
                          echo "<div class='form-check'>";
                          echo "<label class='form-check-label'>";
                          echo "<input type='radio' class='form-check-input' name='opsibenar1' id='OpsiBenar1' value='' checked>";
                          echo $opsi['opsi'];
                        ...
                        if($opsi['id_opsi']==$jaw['id_opsi']){
                          echo "<div class='form-check form-check-danger'>";
                          echo "<label class='form-check-label'>";
                          echo "<input type='radio' class='form-check-input' name='opsisalah1' id='OpsiSalah1' value='' checked disabled>";
                          echo $opsi['opsi'];
                          echo "<i class='input-helper'></i></label>";
                          echo "</div>";
                        }else{
                          echo "<div class='form-check form-check-danger'>";
                          echo "<label class='form-check-label'>";
                          echo "<input type='radio' class='form-check-input' name='opsisalah1' id='OpsiSalah1' value='' disabled>";
                          echo $opsi['opsi'];
                          echo "<i class='input-helper'></i></label>";
                          echo "</div>";
            ...
            echo "</div></div>";
            if($jawaban==$benar){              
              echo "<blockquote class='blockquote blockquote-success' style='background-color:#57B65773;'>
              <footer class='blockquote-footer'><b>Anda menjawab dengan benar</b></footer>                            
            </blockquote>";

            }
            else{
              echo "<blockquote class='blockquote blockquote-danger' style='background-color:#FF474733;'>
                <footer class='blockquote-footer'><b>Anda menjawab dengan kurang tepat</b></footer> 
                <p class='font-weight-bold'>Jawaban yang tepat adalah: ".$opsibenar."</p>                 
              </blockquote>";
            ...
            $getsoal = "SELECT * FROM tb_soal JOIN tb_kuis ON tb_soal.id_kuis=tb_kuis.id_kuis
            JOIN tb_materi ON tb_materi.id_materi=tb_kuis.id_materi WHERE tb_materi.id_materi='".$_GET["id_materi"]."' AND tb_soal.nomor='2'";
            $eksekusi = mysqli_query($conn, $getsoal);
            $soal = mysqli_fetch_array($eksekusi);   
                    ...
                    while($opsi = mysqli_fetch_array($eksopsi)){
                      if($opsi['status']=='Benar'){
                        ...
                        if($opsi['id_opsi']==$jaw['id_opsi']){
                          echo "<div class='form-check'>";
                          echo "<label class='form-check-label'>";
                          echo "<input type='radio' class='form-check-input' name='opsibenar2' id='OpsiBenar2' value='' checked>";
                          echo $opsi['opsi'];
                          echo "<i class='input-helper'></i></label>";
                          echo "</div>";
                        }else{
                        ...
                        if($opsi['id_opsi']==$jaw['id_opsi']){
                          echo "<div class='form-check form-check-danger'>";
                          echo "<label class='form-check-label'>";
                          echo "<input type='radio' class='form-check-input' name='opsisalah2' id='OpsiSalah1' value='' checked disabled>";
                          echo $opsi['opsi'];
                          echo "<i class='input-helper'></i></label>";
                          echo "</div>";
                        }else{
                          echo "<div class='form-check form-check-danger'>";
                          echo "<label class='form-check-label'>";
                          echo "<input type='radio' class='form-check-input' name='opsisalah2' id='OpsiSalah2' value='' disabled>";
                          echo $opsi['opsi'];
                          echo "<i class='input-helper'></i></label>";
                          echo "</div>";
...
<?php
            ...
            $getsoal = "SELECT * FROM tb_soal JOIN tb_kuis ON tb_soal.id_kuis=tb_kuis.id_kuis
            JOIN tb_materi ON tb_materi.id_materi=tb_kuis.id_materi WHERE tb_materi.id_materi='".$_GET["id_materi"]."' AND tb_soal.nomor='3'";
            $eksekusi = mysqli_query($conn, $getsoal);
            $soal = mysqli_fetch_array($eksekusi);   
                    ...
                    while($opsi = mysqli_fetch_array($eksopsi)){
                      if($opsi['status']=='Benar'){
                        ...
                        if($opsi['id_opsi']==$jaw['id_opsi']){
                          echo "<div class='form-check'>";
                          echo "<label class='form-check-label'>";
                          echo "<input type='radio' class='form-check-input' name='opsibenar3' id='OpsiBenar3' value='' checked>";
                          echo $opsi['opsi'];
                          echo "<i class='input-helper'></i></label>";
                          echo "</div>";
                        }else{
                        ...
                        if($opsi['id_opsi']==$jaw['id_opsi']){
                          echo "<div class='form-check form-check-danger'>";
                          echo "<label class='form-check-label'>";
                          echo "<input type='radio' class='form-check-input' name='opsisalah3' id='OpsiSalah3' value='' checked disabled>";
                          echo $opsi['opsi'];
                          echo "<i class='input-helper'></i></label>";
                          echo "</div>";
                        }else{
                          echo "<div class='form-check form-check-danger'>";
                          echo "<label class='form-check-label'>";
                          echo "<input type='radio' class='form-check-input' name='opsisalah3' id='OpsiSalah3' value='' disabled>";
                          echo $opsi['opsi'];
                          echo "<i class='input-helper'></i></label>";
                          echo "</div>";
...
<?php
            ...
            $getsoal = "SELECT * FROM tb_soal JOIN tb_kuis ON tb_soal.id_kuis=tb_kuis.id_kuis
            JOIN tb_materi ON tb_materi.id_materi=tb_kuis.id_materi WHERE tb_materi.id_materi='".$_GET["id_materi"]."' AND tb_soal.nomor='4'";
            $eksekusi = mysqli_query($conn, $getsoal);
            $soal = mysqli_fetch_array($eksekusi);   
                    ...
                    while($opsi = mysqli_fetch_array($eksopsi)){
                      if($opsi['status']=='Benar'){
                        ...
                        if($opsi['id_opsi']==$jaw['id_opsi']){
                          echo "<div class='form-check'>";
                          echo "<label class='form-check-label'>";
                          echo "<input type='radio' class='form-check-input' name='opsibenar4' id='OpsiBenar4' value='' checked>";
                          echo $opsi['opsi'];
                          echo "<i class='input-helper'></i></label>";
                          echo "</div>";
                        }else{
                        ...
                        if($opsi['id_opsi']==$jaw['id_opsi']){
                          echo "<div class='form-check form-check-danger'>";
                          echo "<label class='form-check-label'>";
                          echo "<input type='radio' class='form-check-input' name='opsisalah4' id='OpsiSalah4' value='' checked disabled>";
                          echo $opsi['opsi'];
                          echo "<i class='input-helper'></i></label>";
                          echo "</div>";
                        }else{
                          echo "<div class='form-check form-check-danger'>";
                          echo "<label class='form-check-label'>";
                          echo "<input type='radio' class='form-check-input' name='opsisalah4' id='OpsiSalah4' value='' disabled>";
                          echo $opsi['opsi'];
                          echo "<i class='input-helper'></i></label>";
                          echo "</div>";
            ...
            $getsoal = "SELECT * FROM tb_soal JOIN tb_kuis ON tb_soal.id_kuis=tb_kuis.id_kuis
            JOIN tb_materi ON tb_materi.id_materi=tb_kuis.id_materi WHERE tb_materi.id_materi='".$_GET["id_materi"]."' AND tb_soal.nomor='5'";
            $eksekusi = mysqli_query($conn, $getsoal);
            $soal = mysqli_fetch_array($eksekusi);   
                    ...
                    while($opsi = mysqli_fetch_array($eksopsi)){
                      if($opsi['status']=='Benar'){
                        ...
                        if($opsi['id_opsi']==$jaw['id_opsi']){
                          echo "<div class='form-check'>";
                          echo "<label class='form-check-label'>";
                          echo "<input type='radio' class='form-check-input' name='opsibenar5' id='OpsiBenar5' value='' checked>";
                          echo $opsi['opsi'];
                          echo "<i class='input-helper'></i></label>";
                          echo "</div>";
                        }else{
                        ...
                        if($opsi['id_opsi']==$jaw['id_opsi']){
                          echo "<div class='form-check form-check-danger'>";
                          echo "<label class='form-check-label'>";
                          echo "<input type='radio' class='form-check-input' name='opsisalah5' id='OpsiSalah5' value='' checked disabled>";
                          echo $opsi['opsi'];
                          echo "<i class='input-helper'></i></label>";
                          echo "</div>";
                        }else{
                          echo "<div class='form-check form-check-danger'>";
                          echo "<label class='form-check-label'>";
                          echo "<input type='radio' class='form-check-input' name='opsisalah5' id='OpsiSalah5' value='' disabled>";
                          echo $opsi['opsi'];
                          echo "<i class='input-helper'></i></label>";
                          echo "</div>";
            ...
            ?><br><br>
                    ...
                    <button type="button" name="btn_batalkan" class="btn btn-outline-primary mr-2">Kembali</button></a>
